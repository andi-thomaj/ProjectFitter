...
{
    public class ActivateBiometricLoginRequestValidation : AbstractValidator<ActivateBiometricLoginRequest>
    {
        private readonly IICNumberRepository _icNumberRepository;

        public ActivateBiometricLoginRequestValidation(IICNumberRepository icNumberRepository)
        {
